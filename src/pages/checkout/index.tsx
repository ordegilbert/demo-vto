  ...
  return (
    <div className="min-h-[100dvh] bg-white pb-28 p-4 text-sm">
      ...
      <div className="p-1">
        ...
        <div className="p-4 mt-4 bg-[#FAFAFA] rounded-xl">
          <div className="flex">
            <Chip
              label={
                <span>
            ...
            />
            <p className="ml-2 font-medium">Cupa Cosmetic</p>
          </div>
          ...
          <div className="flex justify-between my-4">
            <div className="flex w-full min-w-0">
              ...
              <div className="ml-2 flex-1 min-w-0">
                <p className="truncate">Lip Stain Tint - 4gr (Pigmented & Transfer Resistant)</p>
                <p className="text-sm text-qua">{shades[3].name}</p>{" "}
                <div className="flex justify-between mt-8">
                  <span className="flex items-end">
                    <p className="text-md text-qua mb-0.5">Rp</p>
                    <p className="text-lg">99.690</p>
        ...
        <div className="bg-white -mx-4 px-4 py-4 mt-1">
          <div className="bg-[#FAFAFA] rounded-xl p-4 flex justify-between items-center mb-4">
